...
//    }
//
//    public void vert(Matrix4f matrix4f, Matrix3f matrix3f, VertexConsumer vertexBuilder, int x, int y, int z, float texU, float texV, int normX, int normZ, int normY, int light) {
...
//
//    @Override
//    public ResourceLocation getTextureLocation(EntityTarantulaHair entity) {
